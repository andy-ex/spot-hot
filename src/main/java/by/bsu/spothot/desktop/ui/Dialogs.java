...
import static by.bsu.spothot.desktop.ui.Dialogs.DialogResources.getIcon;
import static by.bsu.spothot.desktop.ui.Dialogs.DialogResources.getMessage;
import static by.bsu.spothot.desktop.ui.Dialogs.DialogResources.getString;
import static by.bsu.spothot.desktop.ui.Dialogs.DialogResponse.CLOSED;
import static by.bsu.spothot.desktop.ui.Dialogs.DialogResponse.OK;
...
public class Dialogs {
    ...
    private static final URL DIALOGS_CSS_URL = FXDialog.class.getClassLoader().getResource("css/dialogs.css");
    // !CHANGE END!
...
//        }
    ...
    static class DialogResources {
        ...
        private final static ResourceBundle dialogsResourceBundle =
                ResourceBundle.getBundle("conf.dialog-resources");
                ...
                return AccessController.doPrivileged(
                        new PrivilegedExceptionAction<ImageView>()   {
                            @Override public ImageView run() {
                                ...
                                URL url = DialogResources.class.getClassLoader().getResource(resourceName);
                                if (url == null) {
